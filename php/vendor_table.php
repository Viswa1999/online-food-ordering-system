  ...
  //echo $name.$email.$address.$locality.$state.$city.$zip.$description;
	...
	if( $ins )
	{
		...
		else 
		{
			...
			$conn->close();
			$to= $email;
			$subject = "Thank you! | Ethnic Foods";
			$txt = "Thank You for joining us , we will intimate you in case any queries from a customer is made ".$email;
			$headers = "From: 20mx117@psgtech.ac.in";
